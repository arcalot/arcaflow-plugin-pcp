...
Convert the PCP archive to machine-readable format
...
<tr><th>Properties</th><td><details><summary>archive_path (<code>string</code>)</summary>
                ...
                <table><tbody><tr><th>Name:</th><td>pmrep config file path</td></tr><tr><th>Description:</th><td width="500">The file system path to the pmrep config file.</td></tr><tr><th>Required:</th><td>No</td></tr><tr><th>Default (JSON encoded):</th><td><pre><code>&#34;/etc/pcp/pmrep&#34;</code></pre></td></tr><tr><th>Type:</th><td><code>string</code></td></tbody></table>
            </details></td></tr>
